...
class LegacitoSvgRobotWidget extends StatelessWidget {
  final LegacitoMood mood;
  final bool isAnimating;
  final double size;

  const LegacitoSvgRobotWidget({
    super.key,
    required this.mood,
  ...
  Widget _buildSvgRobot() {
    ...
    return SvgPicture.asset(
      ...
      height: (size * 1.75).h,
      fit: BoxFit.contain,
      placeholderBuilder: (context) => _buildFallbackRobot(),
  ...
  Widget _buildFallbackRobot() {
    ...
    return Container(
      ...
      child: Stack(
        alignment: Alignment.center,
        children: [
          // Robot básico como fallback
          _buildBasicRobot(config),
  ...
  Widget _buildBasicRobot(MoodConfig config) {
    return Column(
